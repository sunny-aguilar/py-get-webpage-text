...
if [ "$1" == 'push' ]; then
    ...
    # zip up files
    zip -D aguilasa.zip index.js package.json public/css/style.css views/404.handlebars views/500.handlebars views/get-api.handlebars views/post-api.handlebars views/layouts/main.
    exit 0
